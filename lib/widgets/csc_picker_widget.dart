...
import '../models/cspicker_model.dart';
...
class _CSPickerWidgetState extends State<CSPickerWidget> {
  ...
  @override
  void initState() {
    this._selectedCountry = widget.country == "" ? "country" : widget.country;
    this._selectedCity = widget.city == "" ? "city" : widget.city;
    this._selectedState = widget.state == "" ? "state" : widget.state;
    getCounty();
    super.initState();
  }
      ...
      children: [
        ...
        Container(
          ...
          child: DropdownWithSearch(
            ...
            selected: _selectedCountry != null ? _selectedCountry : "Select Country",
      ...
      children: [
        ...
        Container(
          ...
          child: DropdownWithSearch(
            ...
            selected: _selectedState != null ? _selectedState : "Select State",
      ...
      children: [
        ...
        Container(
          ...
          child: DropdownWithSearch(
            ...
            searchBarRadius: widget.searchBarRadius,
            disabledDecoration: widget.disabledDropdownDecoration,
            selected: _selectedCity != null ? _selectedCity : "Select City",
