...
class InviteMemberNotificationScreen extends StatefulWidget {
  const InviteMemberNotificationScreen({Key? key}) : super(key: key);

  @override
  _InviteMemberNotificationScreenState createState() => _InviteMemberNotificationScreenState();
}

class _InviteMemberNotificationScreenState extends State<InviteMemberNotificationScreen> {
